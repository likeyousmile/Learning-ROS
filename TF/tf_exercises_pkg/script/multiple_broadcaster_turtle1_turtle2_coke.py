...
import time
import tf
#import get_model_gazebo_pose to have current pose
...
class MultiTfBroadcast(object):
    ...
    def __init__(self, robot_name_list, loop_rate=5.0):
        ...
        # get the position and orientation of a gazebo model
    ...
    def start_loop(self):
        ...
        while not rospy.is_shutdown():
            ...
            # get current the position and orientation of desired models 
            #and sends it to the TF publisher at 5 hz
