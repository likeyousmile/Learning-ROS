...
class gurdyJointMover(object):
    ...
    def __init__(self):
        ...
        self.pub_lowerlegM4_joint_position = rospy.Publisher(
            '/gurdy/upperlegM4_lowerlegM4_joint_position_controller/command',
            Float64,
            queue_size=1)
    ...
    def move_gurdy_all_joints(self, upperlegM1_angle, upperlegM2_angle, upperlegM3_angle, upperlegM4_angle, lowerlegM1_value, lowerlegM2_value ,lowerlegM3_value, lowerlegM4_value):
        upperlegM1 = Float64()
        ...
        upperlegM4 = Float64()
        upperlegM4.data = upperlegM4_angle
        ...
        lowerlegM4 = Float64()
        lowerlegM4.data = lowerlegM4_value
        ...
        self.pub_upperlegM4_joint_position.publish(upperlegM4)
        ...
        self.pub_lowerlegM4_joint_position.publish(lowerlegM4)
    ...
    def gurdy_movement_look(self, upperlegM1_angle, upperlegM2_angle, upperlegM3_angle, upperlegM4_angle, lowerlegM1_value, lowerlegM2_value ,lowerlegM3_value, lowerlegM4_value):
        ...
        similar_lowerlegM4 = False

        rate = rospy.Rate(check_rate)
        while not (similar_upperlegM1 and similar_upperlegM2 and similar_upperlegM3 and similar_upperlegM4 and similar_lowerlegM1 and similar_lowerlegM2 and similar_lowerlegM3 and similar_lowerlegM4):
